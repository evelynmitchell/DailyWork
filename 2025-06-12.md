...
https://fieldeffect.com/blog/what-is-an-mfa-fatigue-attack

https://www.honeycomb.io/blog/its-the-end-of-observability-as-we-know-it-and-i-feel-fine

https://minireference.com/ 100% bullshit-free textbooks on high school math, vectors, calculus, mechanics, and linear algebra.

![[Pasted image 20250612203950.png]]
# agent prompts

"Can you do a one pager for a {{service type}} company focused on {{business size}} organizations such as {{example customer}}? For each provided service mentioned in the one pager, can you do a more complete description of the service, including customer benefits, resources needed to provide, costs and prices? In addition can you make a list of SEO words which potential customers may use to search for this?"
